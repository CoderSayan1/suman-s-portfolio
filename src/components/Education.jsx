...
function Education() {
    ...
    const education = [
        {
            ...
            institution: "The Neotia University, South 24 Parganas, West Bengal, India",
            duration: "2024-2026",
            marks: "CGPA- 0"
        },
        {
        ...
        },
        {
            ...
            institution: "Paramanandapur Jagannath Institution, Purba Medinipur, West Bengal, India",
            duration: "2018-2020",
            marks: "Percentage- 88.20%"
        },
        {
            name: "Secondary Education",
            institution: "Gutinagori Aloketirtha Vidyaniketan, Howrah, West Bengal, India",
            duration: "2012-2018",
  ...
  return (
    <div className=' w-full flex flex-col md:flex-row items-center md:justify-between md:h-screen h-full  md:px-20 px-10 md:py-6 py-3 md:my-0 my-12' id='education'>
